            ...
            >
              ...
              <v-tab-item class="moviedesc">
                <dl v-if="movieDatail.meta">
                  ...
                  <dd>
                    <span class="dd-title">IMDB rating：</span>
                    <span class="rate">{{movieDatail.rate}}</span>分
                  </dd>
                  <dd>
                    <span class="dd-title">release date：</span>{{formateDate(movieDatail.pubdate)}}
                  </dd>
                  <dd>
                    <span class="dd-title">tag：</span>{{tags(movieDatail.tags)}}
                  </dd>
                  <dd>
                    <span class="dd-title">genre：</span>{{tags(movieDatail.movieTypes)}}
                  </dd>
                  <dd>
                    <p class="summary">
                      <span class="dd-title">summary：</span>{{movieDatail.summary}}
                    </p>
                  </dd>
                </dl>
              </v-tab-item>
